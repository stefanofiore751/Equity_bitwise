package logic;
import static logic.Card.getRank;
...
public class Card {
    ...
    public static String rankToString(int c) {
    	int index = getRank(c);
    	return RANK_STRINGS[index];
    }
    
    public static String suitToString(int c) {
    	int index = getSuit(c);
    	return SUIT_STRINGS[index];
    }
